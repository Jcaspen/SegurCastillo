...
class EmpresasSearch extends Empresas
{
    ...
    public function rules()
    {
        return [
            [['id', 'poliza'], 'integer'],
            [['cif', 'tomador_dni', 'facturacion_anual'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['ilike', 'cif', $this->cif])
            ->andFilterWhere(['ilike', 'tomador_dni', $this->tomador_dni])
            ->andFilterWhere(['ilike', 'facturacion_anual', $this->facturacion_anual]);
